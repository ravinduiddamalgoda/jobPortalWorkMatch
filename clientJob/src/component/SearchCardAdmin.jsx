  ...
  return (
    <>
      <Card className={classes.root}>
        <Typography variant="h6" className={classes.searchBarHeading}>
          Bring forth the employee who excels above all others.
        </Typography>
        ...
        <Container sx={{ display: "flex", flexDirection: "row" }}>
          ...
          <Typography
            display="inline"
            style={{ textAlign: "left", flex: 1, marginLeft: "25%" }}
          >
            Rating
          </Typography>
        </Container>
            ...
            .map((item) => (
              ...
              <TableRow>
                <Container sx={{ display: "flex" }}>
                  ...
                  >
                    <Link
                      to={`admin/getUserData/${item.email}`}
                  ...
                  <TableCell
                    ...
                    sx={{ borderBottom: "none", display: "flex" }}
                  >
                    <StarRatingEditable email={item.email} />{" "}
                  </TableCell>
                </Container>
              </TableRow>
            ))}
